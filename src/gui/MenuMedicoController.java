...
public class MenuMedicoController {
	...
	private void abrirTelaEscolhaConsulta() {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("EscolherConsultaRealizar.fxml"));
			Parent root = loader.load();
	...
	private void abrirTelaGerarRelatorio() {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("GerarRelatorioMedico.fxml"));
			Parent root = loader.load();
